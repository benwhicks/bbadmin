...
select u.user_id as id, u.student_id as s_id, aa.timestamp, cm.course_id as subject_code,
       ...
       aa.session_id as session_id, aa.event_type as event, aa.internal_handle as handle, aa.data as data, aa.content_pk1
...
where
      ...
      --cm.course_id like 'S-PSY208_201860%' or cm.course_id like 'S-PSY458_201860%'
