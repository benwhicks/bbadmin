...
SELECT
       ...
       max(score / greatest(possible, -1)) as max_grade_so_far, -- returns negative if possible set to zero
       lastaccess_overall,
...
WHERE subject_code like 'S-%201930%' and id is not null
